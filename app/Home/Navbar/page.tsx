...
export default function Navbar() {
  ...
  const links = [
    ...
    { name: "Create CV", href: "http://192.168.21.63:8005/login/" },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center space-x-2">
            <Image src="/logo resumifly.png" alt="Resumifly" width={32} height={32} />
            <span className="text-4xl font-bold text-black">Resumify</span>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <div className="flex items-center space-x-4 ml-6">
              <a href="http://192.168.21.63:8005/login/" className="text-gray-700 hover:text-blue-500">
                LOGIN
              </a>
              <a href="http://192.168.21.63:8005/register/" className="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition">
                REGISTER
              </a>
            </div>
          </div>
